...
func (a *AuthPermitService) FindAuthPointByPermissionCode(db *gorm.DB, permissionCode string) (*entities.AuthPoint, error) {
	return a.AuthPermitRepo.FindAuthPointByPermissionCode(db, permissionCode)
}
